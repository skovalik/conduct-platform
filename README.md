...
- **[recall](https://github.com/skovalik/aurochs-recall)** - cross-session memory: a searchable record of past work.
- **[beads](https://github.com/steveyegge/beads)** - a git-committed issue tracker for ready and in-progress work across sessions.
- **[loop](https://github.com/anthropics/claude-code/tree/main/plugins/ralph-wiggum)** - run a task or check on a recurring interval.
- **[prose-scrub](https://github.com/skovalik/aurochs-llm-scrub)** - strip LLM tells from copy before publishing.
...
- **[code-review](https://github.com/anthropics/claude-code/tree/main/plugins/code-review)** - parallel review of a diff before merge.
- **[pfd](https://github.com/skovalik/perception-first-design)** - Perception-First Design, for evaluating a UI, page, or piece of copy.
- **[superpowers](https://github.com/obra/superpowers)** - disciplined TDD, debugging, and planning workflows.
- **[feature-dev](https://github.com/anthropics/claude-code/tree/main/plugins/feature-dev)** - feature work with an architecture focus.
- **[impeccable](https://github.com/pbakaus/impeccable)** - distinctive frontend design.

**Optional:**

- **[voice](https://github.com/skovalik/aurochs-voice)** - draft in your established writing voice.
